...
<html lang="en">
    ...
    <head>
        ...
        <title>DE MAYOR A MENOR</title>
    </head>
    
    <body style="background: #C6FFDD; background: -webkit-linear-gradient(to right, #f7797d, #FBD786, #C6FFDD);  /* Chrome 10-25, Safari 5.1-6 */
    ...
    <div  style="margin: 5px; float: left; width: 180px;">
        ...
        <div style ="display:flex"> 
            ...
            <button action="" type="submit" style="background-image: linear-gradient(to right, #52c234 0%, #061700  51%, #52c234  100%);
                    ...
                    box-shadow: 0 0 20px #eee;border-radius: 10px;display: block;
                    ">ENVIAR</button>
            </div>
    </form>
</body>
